...
namespace C3AIOOP
{
    public partial class atimdrrmendorsement : Form
    {
        ...
        private void btn_headergenerate_Click(object sender, EventArgs e)
        {
            if (DateTime.Now.Hour < 12)
            {
                previewbox_generate.Text = "Good Morning!\n" +
                    "Endorsement of Duties, Accomplishments and Reports to Outgoing to the Incoming C3 Operators from " + DateTime.Now.AddDays(-1).ToString("MMMM dd, yyyy") + " 2000H to " + DateTime.Now.ToString("MMMM dd, yyyy") + " 0800H" + s1;
            }
            else
            {
                previewbox_generate.Text = "Good Evening!\n" +
                    "Endorsement of Duties, Accomplishments and Reports to Outgoing to the Incoming C3 Operators from " + DateTime.Now.ToString("MMMM dd, yyyy") + " 08000H to " + DateTime.Now.ToString("MMMM dd, yyyy") + " 2000H" + s1;
            }
        }
        ...
        private void atimdrrmendorsement_Load(object sender, EventArgs e)
        {
            txt_more.Text = "Enter any additional information here.";
            txt_more.ForeColor = Color.Gray;
            radio_no.Checked = true;
